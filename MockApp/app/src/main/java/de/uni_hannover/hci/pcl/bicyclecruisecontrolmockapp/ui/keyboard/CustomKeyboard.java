package de.uni_hannover.hci.pcl.bicyclecruisecontrolmockapp.ui.keyboard;
...
public class CustomKeyboard {
    ...
    public CustomKeyboard(Activity activity) {
        ...
        ViewGroup keyboardContainer = (ViewGroup) activity.findViewById(R.id.packed); //TODO change
